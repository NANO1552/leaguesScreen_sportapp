                      ...
                      builder: (context, state) {
                        if (state is LeaguesLoadind) {
                          ...
                          return SingleChildScrollView(
                            child: Column(
                              children: [
                                for (int i = 0; i < state.ourrresponse.result!.length; i++)
                                  InkWell(
                                    onTap: () {
                                      // Navigation to another screen can be added here if needed
                                    },
                                      ...
                                      child: Container(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Expanded(
                                              child: Text(
                                                state.ourrresponse.result![i].leagueName ?? 'Unknown',
                                                style: GoogleFonts.quicksand(
                                                  fontSize: 14.sp,
                                                  color: Colors.black,
                                            ...
                                            SizedBox(
                                              ...
                                              child: CircleAvatar(
                                                ...
                                                child: CachedNetworkImage(
                                                  imageUrl: state.ourrresponse.result![i].leagueLogo ??
